...
"}")
    ...
    def retranslateUi(self, employeeDashboard):
        ...
        ___qtablewidgetitem3.setText(QCoreApplication.translate("employeeDashboard", u"Category", None));
        ___qtablewidgetitem4 = self.products.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("employeeDashboard", u"Price", None));
